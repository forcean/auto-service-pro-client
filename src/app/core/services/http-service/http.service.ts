...
export class HttpService {
  ...
  getText(url: string, queryParams?: any, withCredentials = false): Promise<string> {
    let params = new HttpParams();
    ...
    return lastValueFrom(this.httpClient.get(url, { params, responseType: 'text', withCredentials }));
  }
